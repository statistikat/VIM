...
In addition to [Model based Imputation Methods](http://statistikat.github.io/VIM/articles/modelImp.html) the `VIM` package also presents donor based imputation methods, namely Hot-Deck Imputation and k-Nearest Neighbour Imputation.
