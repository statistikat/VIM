...
- `pmm_k`: A positive integer defining how many nearest observed values are considered in predictive mean matching (PMM); when pmm = TRUE, one of the k values closest to the predicted value is randomly selected for imputation.
