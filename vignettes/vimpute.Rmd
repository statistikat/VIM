...
- `formula`: If not all variables are used as predictors, or if transformations or interactions are required 
             (applies to all X, for Y only transformations are possible). Only applicable for the methods "robust" and "regularized". Provide as a list for each variable that requires specific conditions.
...
You can provide `method` globally as a single value/function (applies to all variables), or as a named list per variable.
...
You can provide `pmm` globally as a single value/function (applies to all numeric variables), or as a named list per variable.
...
You can provide `pmm_k` globally as a single value/function (applies to all variables), or as a named list per variable.
