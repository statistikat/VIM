...
like `kNN()` (k nearest neighbor), `hotdeck()` and so forth. Those functions
...
Note however, that in certain circumstances, there will be missings left in
the returned dataset depending on the method used. 
